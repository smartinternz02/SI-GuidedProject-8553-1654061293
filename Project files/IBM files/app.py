...
API_KEY = "Ie917Ch9o4PXEtlzUFv6UZTlVL_E5Vkg4A3FXzRUVqVI"
...
def y_predict():
    ...
    response_scoring = requests.post('https://eu-gb.ml.cloud.ibm.com/ml/v4/deployments/834249b9-e151-4362-b410-50d38c5f0f9c/predictions?version=2022-03-07', json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
    #print("Scoring response")
    #print(response_scoring.json())
